...
interface ModalState {
  ...
  exportExpensesOpen: boolean; // State for export modal
  ...
  toggleExportExpenses: () => void; // Toggle function for export modal
  closeAll: () => void;
}
...
export const useModalStore = create<ModalState>((set) => ({
  ...
  exportExpensesOpen: false, // Initial state for export modal
  ...
  toggleExportExpenses: () => set((state) => ({
    exportExpensesOpen: !state.exportExpensesOpen,
    // Close other modals
    addExpenseOpen: false,
    addTripOpen: false,
    editTripOpen: false,
  ...
  closeAll: () => set({
    ...
    editingMileageLog: null,
    mileageLogTripId: null,
    exportExpensesOpen: false, // Ensure export modal is closed too
  }),
}));
