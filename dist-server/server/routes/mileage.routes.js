...
export function createMileageLogRouter(storage) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    userProfile = authReq.user;
                    internalUserId = userProfile.id;
                    validatedData = insertMileageLogSchema.parse(req.body);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    updateSchema = rawInsertMileageLogSchema.partial().extend({
    ...
    router.post("/upload-odometer-image", upload.single("odometerImage"), function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    uniquePath = "odometer-images/".concat(internalUserId, "/").concat(uuidv4(), "-").concat(authReq.file.originalname);
                ...
                case 1:
                    ...
                    console.log("Processing odometer image buffer (".concat(authReq.file.mimetype, ") using method: ").concat(method));
                    return [4 /*yield*/, processOdometerImageWithAI(authReq.file.buffer, authReq.file.mimetype, method)];
                case 2:
                    ocrResult = _a.sent();
