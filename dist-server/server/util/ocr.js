        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(apiUrl, { method: "POST", headers: headers, body: JSON.stringify(requestBody) })];
                case 1:
                    response = _p.sent();
...
export function processReceiptWithOCR(fileBuffer_1, mimeType_1) {
...
export function processOdometerImageWithAI(fileBuffer_1, mimeType_1) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 8: return [4 /*yield*/, fetch(testUrl, { headers: headers })];
                case 9:
                    response = _b.sent();
...
export function testOCR(method, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
