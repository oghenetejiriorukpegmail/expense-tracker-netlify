...
export function getUserById(db, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.select().from(schema.users).where(eq(schema.users.id, id)).limit(1)];
                case 1:
                    result = _a.sent();
...
export function getUserByUsername(db, username) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.select().from(schema.users).where(eq(schema.users.username, username)).limit(1)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result[0]];
            }
...
export function getUserByEmail(db, email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.select().from(schema.users).where(eq(schema.users.email, email)).limit(1)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result[0]];
            }
...
export function updateUserProfile(db, userId, profileData) {
    return __awaiter(this, void 0, void 0, function () {
...
export function createUserWithClerkId(db_1, clerkUserId_1) {
    return __awaiter(this, arguments, void 0, function (db, clerkUserId, email, firstName, lastName) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    username = email ? email.split('@')[0] + '-' + Math.floor(Math.random() * 10000) : 'user-' + uuidv4().substring(0, 8);
                    password = uuidv4();
                    userData = {
                        username: username,
                        password: password,
