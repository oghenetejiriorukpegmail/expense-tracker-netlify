...
export function getMileageLogById(db, id) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.select().from(schema.mileageLogs).where(eq(schema.mileageLogs.id, id)).limit(1)];
                case 1:
                    result = _a.sent();
...
export function getMileageLogsByUserId(db, userId, options) {
    return __awaiter(this, void 0, void 0, function () {
        var conditions, sortBy, sortOrderFunc, sortColumn, query, limitValue, offsetValue, finalQuery;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    conditions = [eq(schema.mileageLogs.userId, userId)];
                    ...
                    sortOrderFunc = (options === null || options === void 0 ? void 0 : options.sortOrder) === 'asc' ? asc : desc;
                    ...
                    limitValue = options === null || options === void 0 ? void 0 : options.limit;
                    offsetValue = options === null || options === void 0 ? void 0 : options.offset;
                    finalQuery = limitValue !== undefined
...
export function createMileageLog(db, logData) {
    return __awaiter(this, void 0, void 0, function () {
...
export function updateMileageLog(db, id, logData) {
    return __awaiter(this, void 0, void 0, function () {
...
export function deleteMileageLog(db, id) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.delete(schema.mileageLogs).where(eq(schema.mileageLogs.id, id)).returning({ id: schema.mileageLogs.id })];
                case 1:
                    result = _a.sent();
                    if (result.length === 0) {
