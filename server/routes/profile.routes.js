...
function createProfileRouter(storage) {
    ...
    var profileUpdateSchema = zod_1.z.object({
        firstName: zod_1.z.string().min(1, "First name cannot be empty").default(''),
        lastName: zod_1.z.string().optional().default(''),
        phoneNumber: zod_1.z.string().optional().default(''),
        email: zod_1.z.string().email("Invalid email address"), // Clerk manages email, consider if this should be updatable here
