...
var userStorage = require("./storage/user.storage");
var tripStorage = require("./storage/trip.storage");
var expenseStorage = require("./storage/expense.storage");
var mileageStorage = require("./storage/mileage.storage");
var taskStorage = require("./storage/task.storage");
var fileStorage = require("./storage/file.storage");
...
var SupabaseStorage = /** @class */ (function () {
    function SupabaseStorage() {
        this.client = (0, postgres_1.default)(databaseUrl, { max: 1 });
        this.db = (0, postgres_js_1.drizzle)(this.client, { schema: schema, logger: false });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        PgStore = (0, connect_pg_simple_1.default)(express_session_1.default);
